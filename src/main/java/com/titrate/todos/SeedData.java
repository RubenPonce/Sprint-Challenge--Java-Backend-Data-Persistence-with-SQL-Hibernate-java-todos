...
public class SeedData implements CommandLineRunner
{
    ...
    public void run(String[] args) throws Exception
    {
        ...
        u4.getTodos().add(new Todos("Finish java-orders-swagger", "2019-01-13 04:04:04", u4));
        u4.getTodos().add(new Todos("Feed the turtles", "2019-03-01 04:04:04", u4));
        u4.getTodos().add(new Todos("Complete the sprint challenge", "2019-02-22 04:04:04", u4));

        u3.getTodos().add(new Todos("Walk the dogs", "2019-01-17 04:04:04", u3));
        u3.getTodos().add(new Todos("provide feedback to my instructor", "2019-02-13 04:04:04", u3));
