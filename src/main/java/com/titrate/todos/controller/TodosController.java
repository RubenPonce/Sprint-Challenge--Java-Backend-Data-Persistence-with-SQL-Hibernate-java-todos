package com.titrate.todo.controller;
...
public class TodosController {
    ...
    public ResponseEntity<?> postNewTodo(@PathVariable long userid, @RequestBody Todos todo){
    ...
    public ResponseEntity<?> updateTodo(@PathVariable long todoid, @RequestBody Todos todo){
